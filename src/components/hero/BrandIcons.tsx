// Self-contained filled brand/social icons (lucide has deprecated brand marks).
...
export function MailIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden>
      <path d="M1.5 5A1.5 1.5 0 0 1 3 3.5h18A1.5 1.5 0 0 1 22.5 5v14a1.5 1.5 0 0 1-1.5 1.5H3A1.5 1.5 0 0 1 1.5 19V5zm2.06.5 8.44 6.03L20.44 5.5H3.56zM21 6.9l-8.55 6.1a.75.75 0 0 1-.9 0L3 6.9V19h18V6.9z" />
    </svg>
  );
}
